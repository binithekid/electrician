...
const Footer = () => {
  return (
    <div className="w-full flex flex-col">
      <div className="w-full px-20 py-4 items-center justify-between hidden md:flex flex-row gap-4">
        <Link href="/">
          <Image
            ...
            className="w-auto cursor-pointer h-14 hover:opacity-80 transition-all"
          />
        </Link>
      ...
      <div className="w-full py-3 text-center bg-gray-200">
        <p className="text-sm text-gray-500">2024 Ⓒ Spark Electrics</p>
      </div>
    </div>
  );
};
